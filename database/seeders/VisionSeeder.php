...
class VisionSeeder extends Seeder
{
    ...
    public function run()
    {
        Vision::create([
            ...
            'letter' => 'تسعى أجيال إلى بلورة مفاهيم العمل المجتمعي وفقا لرؤية تتلاءم واحتياجات المجتمع، والى نشر الوعي والإدراك لدي الفئات المستهدفة للمساهمة في عملية التنمية الحقيقية ولتعزيز وتطوير قدرات المجتمع. ',
            'address' => 'أجيال',
